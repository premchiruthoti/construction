    ...
    <>
      <section className='max-w-[1200px] m-auto py-5'>
        ...
        <div className="flex justify-between items-center flex-wrap my-5">
          <div class='max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2 hover:shadow-2xl'>
            <a href='#'>
              <Image
            ...
            <div class='p-5'>
              ...
              <p class='mb-3 font-normal text-amber-600'>
